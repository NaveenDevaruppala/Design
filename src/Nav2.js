    ...
    <section className="body">
        ...
        <div className="frame"> 
         <div style={{display: "flex", flexWrap: "wrap"}}>
          <div style={{width: "30%"}}  >
          <img src={image3} alt="Image" className="ime" style={{width: "140%"}}  />
          </div>
      ...
      <div style={{ width: '86%' }} className="Card6">
      ...
      <div className="img">
      <div >
        <img className="image00" src={image7}/>
        </div>

       <div className="img0"><h4>Black Plastic</h4>
         <img   src={image3}/></div>

        <div className="img01" ><h4>Platinum</h4>
          <img   src={image5}/></div>

        <div className="img02"><h4>Black Platinum</h4>
          <img   src={image6}/></div>
      </div>
   </div>
<br/>
<div style={{ display: 'flex', justifyContent: 'space-between' }} className="Card8">
      <p style={{ width: '40%',background:'rgb(50, 5, 69)' }} className="t27">Card Application (USD)</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)' }} className="t28">$250</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)' }} className="t28">$550</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)'   }} className="t28">$550</p>
    </div>
    <hr className="hr1" /><br />
    <div style={{ display: 'flex', justifyContent: 'space-between' }} className="Card8">
      <p style={{ width: '43%',background:'rgb(50, 5, 69)' }} className="t27">SolSwipe NFT Requirement</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)'}} className="t28">0</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)' }} className="t28">1</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)' }} className="t28">1</p>
    </div>
    <hr className="hr1" /><br />
    <div style={{ display: 'flex', justifyContent: 'space-between' }} className="Card8">
      <p style={{ width: '40%',background:'rgb(50, 5, 69)'}} className="t27">Card Replacement Fee (USD)</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)'}} className="t28">Text 2</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)' }} className="t28">Text 3</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)'}} className="t28">Text 4</p>
    </div><hr className="hr1" /><br />
    <div style={{ display: 'flex', justifyContent: 'space-between' }} className="Card8">
      <p style={{ width: '26%',background:'rgb(50, 5, 69)'}} className="t27">Card Loading Fee (%)</p>
      <p style={{ width: '30%',background:'rgb(50, 5, 69)' }} className="t28">2.25% (-0.5% for Solswipe <br/><br/>NFT holders)</p>
      <p style={{width: '30%',background:'rgb(50, 5, 69)' }} className="t28">2.25% (-0.5% for Solswipe <br/><br/> NFT holders) </p>
      <p style={{ width: '30%',background:'rgb(50, 5, 69)'   }} className="t28">2.25% (-0.5% for Solswipe<br/><br/> NFT holders)</p>
    </div><hr className="hr1" /><br />
    <div style={{ display: 'flex', justifyContent: 'space-between' }} className="Card8">
      <p style={{ width: '41%',background:'rgb(50, 5, 69)' }} className="t27">SolSwipe NFT Requirement</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)' }} className="t28">N/A</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)' }} className="t28">N/A</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)'   }} className="t28">N/A</p>
    </div>    <hr className="hr1" /><br />
    <div style={{ display: 'flex', justifyContent: 'space-between' }} className="Card8">
      <p style={{ width: '35%',background:'rgb(50, 5, 69)' }} className="t27">Loading Cap</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)' }} className="t28">$30,000 / Month</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)' }} className="t28">$75,000 / Month</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)'  }} className="t28">N/A</p>
    </div>
    <hr className="hr1" /><br />
    <div style={{ display: 'flex', justifyContent: 'space-between' }} className="Card8">
      <p style={{ width: '38%',background:'rgb(50, 5, 69)' }} className="t27">Minimum First Load</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)' }} className="t28">0 / Month</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)' }} className="t28">0 / Month</p>
      <p style={{ width: '35%',background:'rgb(50, 5, 69)'   }} className="t28">0 / Month</p>
    </div>    <hr classNam="hr1" />
    <div style={{ display: 'flex',padding:'25px',background:'rgb(50, 5, 69)' , height:'90px',width:'48%',justifyContent: 'space-between',margin:'0 0 0 26%'  }} className="Card9">
      <span><button style={{ width: '25%' }} className="btn3">APPLY FOR THIS CARD</button></span><span>
      <button style={{ width: '25%' }} className="btn4">APPLY FOR THIS CARD</button></span><span>
      <button style={{ width: '25%' }} className="btn5">APPLY FOR THIS CARD</button></span>
    </div><hr className="hr2" />
    <div style={{height:'130px',width:'85%',margin:'0 0 0 7%',background:'rgb(93, 22, 123)'}} className="Card10">
    <p className="t29"><br/>Note:</p>
    <p className="t30"><br/><br/>Card issuance fees include the physical card, fright charges, and the opening of offshore bank account. (No bank book).</p>
    </div><br /><br/><br /><br/><br/><br/><br/>
   
    </section>
    <svg width="1940" height="2" viewBox="0 80 1440 12" fill="none" xmlns="http://www.w3.org/2000/svg"className="ll2">
